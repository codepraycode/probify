...
<Summary title="🎯 Learning Goals for the Whole Journey">
...
- **Video lessons** to simplify the hard stuff
- **Interactive exercises** to practice what you’ve learned
- **Real-world examples** to bring concepts to life
- **Quizzes** that unlock new content (get 60% or higher to move forward!)
